...
function App() {
  ...
  return (
    ...
    <div className="container">
      ...
      <FontAwesomeIcon icon={faBackward} onClick={handlePrevSong} className="musicControler" />
      <FontAwesomeIcon icon={isAudioPlaying ? faPauseCircle : faPlayCircle} onClick={handleAudioPlay} className="playBtn" />
      <FontAwesomeIcon icon={faForward} onClick={handleNextSong} className="musicControler" />
    </div>
      </div>
